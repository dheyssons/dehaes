...
const services = [
  { name: 'Daktimmers', description: "", href: '/services/daktimmer', icon: AiOutlineFileDone },
  { name: 'Groendaken', description: "", href: '/services/groendaken', icon: BiCheckShield },
  { name: 'Gevelbekleding', description: "", href: '/services/gevelbekleding', icon: MdOutlineWorkspacePremium },
  { name: 'Platte daken', description: "", href: '/services/plattedaken', icon: PhoneIcon },
  { name: 'Renovatie', description: "", href: '/services/renovatie',  icon: PhoneIcon },
  { name: 'Isolatie', description: "", href: '/services/isolatie', icon: PhoneIcon },
]
const callsToAction = [
  { name: 'Bezoek onze Facebook', href: 'https://www.facebook.com/people/Schrijnwerkerij-De-Haes/61552704719361/#', icon: ArrowRightStartOnRectangleIcon },
  { name: 'Vraag een offerte aan', href: `https://api.whatsapp.com/send?phone=${config.whatsappNumber}`, icon: ImWhatsapp },
]
        ...
        <nav aria-label="Global" className="flex flex-row items-center justify-around">
          <motion.div variants={dropdown} initial="variantInit" whileInView="variantAnim" viewport={{once:true}} transition={transition1_s} className="max-w-max lg:flex-1 flex flex-row items-center gap-x-4 pt-3">
            ...
            <motion.div variants={dropdown} className='flex flex-col'>
              ...
              <p className='text-[#121212] p small hidden lg:flex'>{config.localAddress}</p>

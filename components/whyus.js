...
export default function Whyus() {
  return (
    <section className="flex flex-col gap-y-10 items-center">
      <div className="flex flex-col lg:flex-row !items-center lg:items-start lg:justify-between w-full pt-10">
        <h2 className="h2 !text-center lg:text-start mb-8">
      ...
      <div className="flex flex-col gap-y-6 lg:flex-row gap-x-6 justify-between w-full">
        ...
        <div className="flex flex-col items-center border border-[--primary-color] gap-y-2 rounded-md p-8 lg:p-14 shadow-sm bg-white">
          ...
          <h6 className="h6">Duurzaamheid</h6>
          <p className="p !text-center lg:mt-5">
        ...
        <div className=" flex flex-col items-center border border-[--primary-color] gap-y-2 rounded-md p-8 lg:p-14 shadow-sm bg-white">
          ...
          <h6 className="h6 text-[--primary-color]">Ervaring</h6>
          <p className="p !text-center lg:mt-5">
        ...
        <div className="flex flex-col items-center border border-[--primary-color] gap-y-2 rounded-md p-8 lg:p-14 shadow-sm bg-white">
          ...
          <h6 className="h6 text-[--primary-color]">Kwaliteit</h6>
          <p className="p !text-center lg:mt-5">

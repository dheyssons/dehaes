// app/[locale]/dakwerken-duffel/page.tsx
...
// -------------------- Page --------------------
export default function DakwerkenDuffelPage() {
  const t = useTranslations();

  // Assumes messages include: { "cityPages": { "duffel": { ... } } }
  const cityPages = t.raw("cityPages") as MessagesRoot["cityPages"];
  const data = cityPages.duffel;

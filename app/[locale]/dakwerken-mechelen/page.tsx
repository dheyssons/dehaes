// app/[locale]/dakwerken-mechelen/page.tsx
...
// -------------------- Page --------------------
export default function DakwerkenMechelenPage() {
  const t = useTranslations();

  // Assumes messages include: { "cityPages": { "mechelen": { ... } } }
  const cityPages = t.raw("cityPages") as MessagesRoot["cityPages"];
  const data = cityPages.mechelen;

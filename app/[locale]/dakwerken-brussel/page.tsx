// app/[locale]/dakwerken-brussel/page.tsx
...
// -------------------- Page --------------------
export default function DakwerkenBrusselPage() {
  const t = useTranslations();

  // Assumes messages include: { "cityPages": { "brussel": { ... } } }
  const cityPages = t.raw("cityPages") as MessagesRoot["cityPages"];
  const data = cityPages.brussel;

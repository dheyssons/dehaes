// app/[locale]/dakwerken-antwerpen/page.tsx
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const root = t.raw("cityPages") as MessagesRoot["cityPages"];
  const city = root.antwerpen;
...
// -------------------- Page --------------------
export default function DakwerkenAntwerpenPage() {
  const t = useTranslations();

  // IMPORTANT: no dots in keys needed. We read the object tree with raw().
  // This assumes your messages JSON contains:
  // { "cityPages": { "antwerpen": { ... } } }
  const cityPages = t.raw("cityPages") as MessagesRoot["cityPages"];
  const data = cityPages.antwerpen;

    ...
    <div className="container mx-auto flex flex-col max-w-sm md:max-w-xl lg:max-w-screen-xl gap-y-20 pt-40">
      ...
      <div className="flex flex-col gap-y-4 overflow-hidden">
        <div className="flex flex-row items-center">
          ...
          <h5 className="h5 !text-[--primary-color]">Projecten</h5>
        </div>
        <motion.h1
          variants={upward}
          initial="variantInit"
        ...
        <div className="flex flex-col gap-y-4">
          <p className="p small !max-w-screen-md">
            ...
            degelijke materialen en met vakmanschap geplaatst, is dus van groot
            belang. De Haes heeft een uitzonderlijke ervaring en know-how
            opgebouwd inzake daktimmers, zowel traditioneel als met spanten.
            Alle timmerwerken gebeuren in de stevigste houtsoorten met
            drenkingsattest – uw garantie tegen houtrot en eventuele
            verzakkingen.
          </p>
          <p className="p small !max-w-screen-md">
            De moderne architectuur stelt daktimmerlui vaak voor grote
            uitdagingen. Ingewikkelde dakconstructies gebeuren dan ook steeds in
            nauw overleg met de architect. Ook voor renovatieprojecten mag u
            rekenen op een perfecte uitvoering in stevige materialen die de tijd
            doorstaan. U hebt steeds de keuze tussen een afwerking met of zonder
            onderdak. Ook veluxramen worden vakkundig geplaatst voor een
            prijs/kwaliteitsverhouding die elke vergelijking met concurrenten
            kan doorstaan.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-y-24">
          ...
          <div className="flex flex-col gap-y-10">
            <div>
              ...
              <h3 className="h3">Daktimmer, dakkapel en gevelbekleding</h3>
            </div>
          ...
          <div className="flex flex-col gap-y-10">
            <div>
              ...
              <h3 className="h3">Gevelbekleding</h3>
            </div>
          ...
          <div className="flex flex-col gap-y-10">
            <div>
              ...
              <h3 className="h3">Timmerwerk en gevelbekleding</h3>
            </div>

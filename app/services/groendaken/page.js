      ...
      <section className="container mx-auto max-w-screen-xl pt-32">
        <div className="bg-white py-12">
          <div className="container mx-auto px-4">
            {/* Título */}
            <h2 className="h2 font-bold !text-[--primary-color]">Groendaken</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-8">
              ...
              <div className="space-y-6">
                <p className="text-gray-700 p small leading-relaxed">
                  ...
                  isolatiecapaciteiten van planten helpt het de
                  binnentemperatuur te reguleren, waardoor de behoefte aan{" "}
                ...
                <p className="text-gray-700 p small leading-relaxed">
                  ...
                  verminderen. Ze{" "}
                  <strong className="text-[--primary-color]">filteren</strong>{" "}
                  ook vervuilende stoffen uit de lucht en bevorderen de
                  biodiversiteit door een leefomgeving te creëren voor{" "}
              ...
              <div className="rounded-md max-w-md overflow-hidden shadow-md">
                <Image src={GroendakenImage} alt="Groendaken" className="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                ...
                van het project. Neem contact op voor een vrijblijvende offerte.
              </p>
            </div>
          </div>
        </div>
